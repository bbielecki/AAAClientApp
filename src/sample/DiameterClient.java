...
public class DiameterClient {
    ...
    Message processReply(Message reply)
    {
        ...
        if(reply==null) {
            System.out.println(log = "Brak odpowiedzi");
        ...
        if(result_code==null) {
            System.out.println(log = "Brak kodu wyniku");
            PrintedStrings.stringsToPrint.add(log);
            return null;
        }
        try {
            ...
            switch(rc) {
                case ProtocolConstants.DIAMETER_RESULT_MULTI_ROUND_AUTH:
                    System.out.println(log = "Wielorundowe uwierzytelnienie");
                    PrintedStrings.stringsToPrint.add(log);
                    ...
                    try {
                        ...
                        if (new AVP_Integer32(elements[0]).queryValue() != 5){
                            System.out.println(log = "Nieznany sposób wielorundowego uwierzytelnienia ");
                            PrintedStrings.stringsToPrint.add(log);
                            return null;
                        }
            ...
            System.out.println(log = "result-code was illformed");
            PrintedStrings.stringsToPrint.add(log);
            return null;
        }
        return nextMessage;
